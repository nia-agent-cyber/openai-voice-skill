...
import { r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-DIZHLisQ.js";
...
import { i as loadGatewayTlsRuntime$1, n as callGateway } from "./call-Dtpvvcxa.js";
...
import { $ as approveNodePairing, $n as resolveTtsPrefsPath, $t as loadCombinedSessionStoreForGateway, An as consumeGatewaySigusr1RestartAuthorization, Bn as isSystemEventContextChanged, Bt as emitAgentEvent, C as buildControlUiAvatarUrl, Cn as resolveSessionDeliveryTarget, Cr as resolveAgentIdentity, Ct as normalizeMimeList, Dn as runWithModelFallback, Dr as createInternalHookEvent, Dt as runEmbeddedPiAgent, Er as clearInternalHooks, Et as stopSubagentsForRequester, Fn as normalizeCronJobPatch, Ft as getHookType, G as normalizeSendPolicy, Gn as OPENAI_TTS_MODELS, H as setCliSessionId, Hn as requestHeartbeatNow, Ht as onAgentEvent, I as getChannelActivity, In as migrateLegacyCronPayload, It as isExternalHookSession, J as primeRemoteSkillsCache, Jn as isTtsEnabled, K as resolveSendPolicy, Kn as OPENAI_TTS_VOICES, Kt as applyModelOverrideToSessionEntry, Lt as initSubagentRegistry, M as onHeartbeatEvent, Mn as scheduleGatewaySigusr1Restart, Mt as createOpenClawTools, Nn as setGatewaySigusr1RestartPolicy, Nt as buildSafeExternalPrompt, O as buildHistoryContextFromEntries, Or as registerInternalHook, Ot as abortEmbeddedPiRun, Pn as normalizeCronJobCreate, Pt as detectSuspiciousPatterns, Q as setSkillsRemoteRegistry, Qn as resolveTtsConfig, Qt as listSessionsFromStore, R as dispatchInboundMessage, Rt as resolveAgentTimeoutMs, S as CONTROL_UI_AVATAR_PREFIX, Sn as resolveOutboundTarget, St as extractImageContentFromSource, T as resolveAssistantAvatarUrl, Tn as resetDirectoryCache, Tr as resolveIdentityName, Tt as isAbortTrigger, U as runCliAgent, Ut as registerAgentRunContext, V as getCliSessionId, Vt as getAgentRunContext, W as loadCostUsageSummary, Wn as getPluginToolMeta, Wt as resolveAnnounceTargetFromKey, X as refreshRemoteBinsForConnectedNodes, Xn as resolveTtsApiKey, Y as recordRemoteNodeInfo, Yn as isTtsProviderConfigured, Z as refreshRemoteNodeBins, Zn as resolveTtsAutoMode, Zt as listAgentsForGateway, _n as ensureOutboundSessionEntry, _r as formatUserTime, _t as DEFAULT_INPUT_PDF_MAX_PAGES, an as readSessionMessages, ar as setCommandLaneConcurrency, at as verifyNodeToken, bt as DEFAULT_INPUT_TIMEOUT_MS, cn as stripEnvelopeFromMessages, cr as stopDiagnosticHeartbeat, d as handleReset, dn as lookupContextTokens, dt as DEFAULT_INPUT_FILE_MAX_BYTES, en as loadSessionEntry, er as resolveTtsProviderOrder, et as listNodePairing, fn as extractShortModelName, ft as DEFAULT_INPUT_FILE_MAX_CHARS, gr as normalizePollInput, gt as DEFAULT_INPUT_MAX_REDIRECTS, hn as loadModelCatalog, ht as DEFAULT_INPUT_IMAGE_MIMES, in as capArrayByJsonBytes, it as updatePairedNodeMetadata, j as getLastHeartbeatEvent, jn as isGatewaySigusr1RestartExternallyAllowed, jt as registerUnhandledRejectionHandler, k as resolveHeartbeatVisibility, kn as authorizeGatewaySigusr1Restart, kr as triggerInternalHook, kt as waitForEmbeddedPiRunEnd, lr as isDiagnosticsEnabled, lt as applyVerboseOverride, mn as normalizeGroupActivation, mr as stripHeartbeatToken, mt as DEFAULT_INPUT_IMAGE_MAX_BYTES, n as handleSlackHttpRequest, nn as resolveSessionModelRef, nr as setTtsProvider, nt as renamePairedNode, on as readSessionPreviewItemsFromTranscript, or as CommandLane, ot as getSkillsSnapshotVersion, pn as clearSessionQueues, pt as DEFAULT_INPUT_FILE_MIMES, q as getRemoteSkillEligibility, qn as getTtsProvider, qt as loadProviderUsageSummary, rn as archiveFileOnDisk, rr as textToSpeech, rt as requestNodePairing, sn as resolveSessionTranscriptCandidates, sr as startDiagnosticHeartbeat, st as registerSkillsChangeListener, t as loadOpenClawPlugins, tn as resolveGatewaySessionStoreTarget, tr as setTtsEnabled, tt as rejectNodePairing, un as hasNonzeroUsage, ur as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, ut as parseVerboseOverride, vn as resolveOutboundSessionRoute, vr as resolveUserTimeFormat, vt as DEFAULT_INPUT_PDF_MAX_PIXELS, w as normalizeControlUiBasePath, wr as resolveEffectiveMessagesConfig, wt as formatZonedTimestamp, xt as extractFileContentFromSource, yr as resolveUserTimezone, yt as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, z as createReplyDispatcher, zn as enqueueSystemEvent, zt as clearAgentRunContext } from "./loader-Cfr5xHjD.js";
...
import "./onboard-channels-D2f91OMm.js";
...
import { m as detectMime, r as saveMediaBuffer } from "./routes-bV4w8l-u.js";
import { B as normalizeVerboseLevel, H as supportsXHighThinking, I as normalizeElevatedLevel, L as normalizeReasoningLevel, M as formatThinkingLevels, N as formatXHighModelHint, R as normalizeThinkLevel, z as normalizeUsageDisplay } from "./pi-embedded-helpers-D_C0aBeX.js";
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-DSL0tQwM.js";
import { F as resolveExplicitAgentSessionKey, I as resolveMainSessionKey, J as expandPolicyWithPluginGroups, K as buildPluginToolGroups, L as resolveMainSessionKeyFromConfig, P as resolveAgentMainSessionKey, Q as stripPluginOnlyAllowlist, S as mergeDeliveryContext, X as normalizeToolName, Z as resolveToolProfilePolicy, b as deliveryContextFromSession, d as loadSessionStore, g as updateSessionStore, q as collectExplicitAllowlist, w as normalizeSessionDeliveryFields, z as snapshotSessionOrigin } from "./sandbox-BWSwbQA_.js";
import { m as formatUsd, p as formatTokenCount } from "./channel-summary-DpCL1euT.js";
import { i as getMachineDisplayName, r as createBrowserRouteDispatcher } from "./wsl-B3YTvHEB.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-DtwGIkTI.js";
import "./image-J7VYNrMv.js";
...
import { c as resolveSubagentToolPolicy, i as filterToolsByPolicy, o as resolveEffectiveToolPolicy, s as resolveGroupToolPolicy } from "./commands-fQy6pM6Y.js";
import "./pairing-store-DMex6WWe.js";
import "./login-qr-Cc7D1YwI.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BSY9cCv1.js";
import "./daemon-runtime-BBj736Xf.js";
import "./service-BoDHq_LN.js";
import "./systemd-DAgZTW06.js";
import "./shared-DBGw227P.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-D6OWor0u.js";
import "./service-audit-N3BNUzVl.js";
...
import { i as probeGateway } from "./audit-imKHTZY0.js";
import { _ as resolveControlUiRootSync, g as resolveControlUiRootOverrideSync, h as ensureControlUiAssetsBuilt, n as installSkill, v as discoverGatewayBeacons } from "./onboard-skills-9cKoTkQK.js";
import { c as startHeartbeatRunner, n as formatHealthChannelLines, o as runHeartbeatOnce, r as getHealthSnapshot, s as setHeartbeatsEnabled } from "./health-format-Dh3G_vJr.js";
import { c as compareSemverStrings, f as DEFAULT_PACKAGE_CHANNEL, h as normalizeUpdateChannel, s as checkUpdateStatus, t as runGatewayUpdate, u as resolveNpmChannelTag } from "./update-runner-DRdWxvSI.js";
import "./github-copilot-auth-B4PHsmOi.js";
...
import { f as runOnboardingWizard, n as getStatusSummary, s as loadAgentIdentity, u as loadAgentIdentityFromWorkspace } from "./status-a2CXC71D.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CWkBweWW.js";
import "./tui-C2gD-O_E.js";
...
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-CrKNcCpf.js";
import "./node-service-BW_LhY5w.js";
import "./status.update-CRyaeUEL.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-UmCOZkxb.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Di2W3Gt8.js");
