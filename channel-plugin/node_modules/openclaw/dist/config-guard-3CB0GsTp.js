...
import { a as readConfigFileSnapshot, h as parseDurationMs, n as createConfigIO, r as loadConfig, s as writeConfigFile } from "./config-ESqpIB27.js";
import { n as movePathToTrash } from "./server-context-CM_E6wD5.js";
import { n as callGateway, r as randomIdempotencyKey } from "./call-Dtpvvcxa.js";
...
import { D as runMemoryStatus, E as registerMemoryCli, En as CHANNEL_MESSAGE_ACTION_NAMES, Ln as CHANNEL_TARGETS_DESCRIPTION, Rn as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, dn as lookupContextTokens, f as moveToTrash, gn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, ln as resolveCommitHash, m as openUrl, s as detectBrowserOpenSupport, v as resolveControlUiLinks, wn as formatTargetDisplay, x as waitForGatewayReachable } from "./loader-Cfr5xHjD.js";
...
import { n as setupChannels } from "./onboard-channels-D2f91OMm.js";
...
import { d as loadSessionStore } from "./sandbox-BWSwbQA_.js";
import { r as runCommandWithRuntime } from "./cli-utils-DFbPmfWB.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-DYKzhXUL.js";
import { a as getFlagValue, c as getVerboseFlag, l as hasFlag, o as getPositiveIntFlagValue, r as registerSubCliCommands } from "./register.subclis-Dc8Cp5BJ.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-uGhPZ_kK.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-CMDz5f-p.js";
import { t as createDefaultDeps } from "./deps-BSY9cCv1.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BBj736Xf.js";
...
import { d as applyAuthChoice, f as upsertSharedEnvVar, m as promptAuthChoiceGrouped, p as applyGoogleGeminiModelDefault, u as warnIfModelConfigLooksOff } from "./onboard-skills-9cKoTkQK.js";
import { i as healthCommand } from "./health-format-Dh3G_vJr.js";
import { $ as buildTokenProfileId, B as setAnthropicApiKey, C as applyOpenrouterConfig, D as applyVeniceConfig, G as setOpencodeZenApiKey, H as setKimiCodingApiKey, J as setVeniceApiKey, K as setOpenrouterApiKey, N as applyZaiConfig, T as applySyntheticConfig, U as setMinimaxApiKey, V as setGeminiApiKey, W as setMoonshotApiKey, X as setXiaomiApiKey, Y as setVercelAiGatewayApiKey, Z as setZaiApiKey, et as validateAnthropicSetupToken, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyXiaomiConfig, k as applyVercelAiGatewayConfig, m as applyMinimaxApiConfig, q as setSyntheticApiKey, v as applyAuthProfileConfig, x as applyMoonshotConfig, y as applyKimiCodeConfig } from "./github-copilot-auth-B4PHsmOi.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BnUUuH3y.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-a2CXC71D.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-CrKNcCpf.js";
import { t as formatHelpExamples } from "./help-format-af1XWYxC.js";
import { a as CONFIGURE_WIZARD_SECTIONS, n as configureCommandWithSections, t as configureCommand } from "./configure-CRkOaBqG.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CTe0ZDxD.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-D2sPCkxz.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-t6qN0X-T.js");
