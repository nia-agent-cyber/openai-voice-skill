...
import { a as readConfigFileSnapshot, s as writeConfigFile } from "./config-CPRL_xgJ.js";
...
import { a as globalInstallArgs, c as compareSemverStrings, d as DEFAULT_GIT_CHANNEL, f as DEFAULT_PACKAGE_CHANNEL, g as resolveEffectiveUpdateChannel, h as normalizeUpdateChannel, i as detectGlobalInstallManagerForRoot, l as fetchNpmTagVersion, m as formatUpdateChannelLabel, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as channelToNpmTag, r as detectGlobalInstallManagerByPresence, s as checkUpdateStatus, t as runGatewayUpdate, u as resolveNpmChannelTag } from "./update-runner-GHcvS82S.js";
import { t as renderTable } from "./table-DuNe7Qes.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-0llkyCU7.js";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-fBkQd2hg.js");
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-Nz9EGR_4.js");
