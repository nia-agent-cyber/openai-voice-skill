import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, R as normalizeElevatedLevel, V as normalizeUsageDisplay, W as supportsXHighThinking, z as normalizeReasoningLevel } from "./pi-embedded-helpers-DPMWK4wW.js";
import { $n as setCommandLaneConcurrency, An as resolveEffectiveMessagesConfig, Ar as normalizeMimeList, At as normalizeControlUiBasePath, B as runWithModelFallback, Bn as OPENAI_TTS_VOICES, Bt as rejectNodePairing, C as resolveSessionModelRef, Cn as registerAgentRunContext, Cr as DEFAULT_INPUT_MAX_REDIRECTS, D as readSessionPreviewItemsFromTranscript, Dr as DEFAULT_INPUT_TIMEOUT_MS, E as readSessionMessages, Er as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, F as resolveOutboundTarget, Fn as clearInternalHooks, Ft as refreshRemoteBinsForConnectedNodes, G as scheduleGatewaySigusr1Restart, Gn as resolveTtsAutoMode, Gt as getSkillsSnapshotVersion, H as authorizeGatewaySigusr1Restart, Hn as isTtsEnabled, Ht as requestNodePairing, I as resolveSessionDeliveryTarget, In as createInternalHookEvent, It as refreshRemoteNodeBins, J as normalizeCronJobPatch, Jn as resolveTtsProviderOrder, K as setGatewaySigusr1RestartPolicy, Kn as resolveTtsConfig, Kt as registerSkillsChangeListener, Ln as registerInternalHook, Lt as setSkillsRemoteRegistry, M as resolveOutboundSessionRoute, Mn as formatUserTime, Mr as resolveAgentTimeoutMs, Mt as getRemoteSkillEligibility, Nn as resolveUserTimeFormat, Nt as primeRemoteSkillsCache, O as resolveSessionTranscriptCandidates, Or as extractFileContentFromSource, Ot as CONTROL_UI_AVATAR_PREFIX, Pn as resolveUserTimezone, Pt as recordRemoteNodeInfo, Q as requestHeartbeatNow, Qt as registerUnhandledRejectionHandler, R as resetDirectoryCache, Rn as triggerInternalHook, Rt as approveNodePairing, S as resolveGatewaySessionStoreTarget, Sn as onAgentEvent, Sr as DEFAULT_INPUT_IMAGE_MIMES, T as capArrayByJsonBytes, Tn as normalizePollInput, Tr as DEFAULT_INPUT_PDF_MAX_PIXELS, U as consumeGatewaySigusr1RestartAuthorization, Un as isTtsProviderConfigured, Ut as updatePairedNodeMetadata, Vn as getTtsProvider, Vt as renamePairedNode, W as isGatewaySigusr1RestartExternallyAllowed, Wn as resolveTtsApiKey, Wt as verifyNodeToken, Xn as setTtsProvider, Xt as normalizeGroupActivation, Y as migrateLegacyCronPayload, Yn as setTtsEnabled, Zn as textToSpeech, _ as resolveAnnounceTargetFromKey, _n as initSubagentRegistry, _r as loadModelCatalog, _t as handleReset, a as loadCostUsageSummary, b as loadCombinedSessionStoreForGateway, bn as emitAgentEvent, br as DEFAULT_INPUT_FILE_MIMES, c as clearSessionQueues, cn as getChannelActivity, cr as stripHeartbeatToken, ct as handleSlackHttpRequest, d as waitForEmbeddedPiRunEnd, dn as dispatchInboundMessage, dr as applyModelOverrideToSessionEntry, en as buildHistoryContextFromEntries, er as CommandLane, et as getPluginToolMeta, f as createOpenClawTools, fn as createReplyDispatcher, fr as applyVerboseOverride, g as isExternalHookSession, gn as stopSubagentsForRequester, h as getHookType, hn as isAbortTrigger, hr as isSystemEventContextChanged, i as runCliAgent, in as onHeartbeatEvent, ir as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, j as ensureOutboundSessionEntry, jn as resolveIdentityName, jt as resolveAssistantAvatarUrl, k as stripEnvelopeFromMessages, kn as resolveAgentIdentity, kr as extractImageContentFromSource, kt as buildControlUiAvatarUrl, l as runEmbeddedPiAgent, lr as lookupContextTokens, m as detectSuspiciousPatterns, mn as formatZonedTimestamp, mr as enqueueSystemEvent, n as getCliSessionId, nr as stopDiagnosticHeartbeat, nt as loadProviderUsageSummary, o as normalizeSendPolicy, p as buildSafeExternalPrompt, pn as extractShortModelName, pr as parseVerboseOverride, q as normalizeCronJobCreate, qn as resolveTtsPrefsPath, r as setCliSessionId, rn as getLastHeartbeatEvent, rr as isDiagnosticsEnabled, s as resolveSendPolicy, st as hasNonzeroUsage, tn as resolveHeartbeatVisibility, tr as startDiagnosticHeartbeat, tt as loadOpenClawPlugins, u as abortEmbeddedPiRun, v as listAgentsForGateway, vr as DEFAULT_INPUT_FILE_MAX_BYTES, w as archiveFileOnDisk, wr as DEFAULT_INPUT_PDF_MAX_PAGES, x as loadSessionEntry, xn as getAgentRunContext, xr as DEFAULT_INPUT_IMAGE_MAX_BYTES, y as listSessionsFromStore, yn as clearAgentRunContext, yr as DEFAULT_INPUT_FILE_MAX_CHARS, zn as OPENAI_TTS_MODELS, zt as listNodePairing } from "./reply-9Z2moGyL.js";
...
import { c as saveMediaBuffer, l as detectMime } from "./routes-lAIMdA5d.js";
...
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CJVIyNF6.js";
import { i as getMachineDisplayName, t as createBrowserRouteDispatcher } from "./dispatcher-DWpX5ArK.js";
import "./manager-DBm6jhZp.js";
import "./sqlite-Dz6S6ijV.js";
import { m as formatUsd, p as formatTokenCount } from "./channel-summary-BKTOg-j6.js";
...
import { i as loadGatewayTlsRuntime$1, n as callGateway } from "./call-CuC93A-a.js";
import "./login-qr-Bgo7bBzB.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-DTymYW8a.js";
...
import { r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-Bx9cgxre.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-D_23Hmzv.js";
...
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-D0uf1JeF.js";
...
import { d as resolveControlUiRootOverrideSync, f as resolveControlUiRootSync, i as discoverGatewayBeacons, n as installSkill, u as ensureControlUiAssetsBuilt } from "./onboard-skills-CquUikaR.js";
import "./github-copilot-auth-oL7fYDeW.js";
import "./onboard-channels-_9yDyVH-.js";
...
import { c as startHeartbeatRunner, n as formatHealthChannelLines, o as runHeartbeatOnce, r as getHealthSnapshot, s as setHeartbeatsEnabled } from "./health-format-DkO-XxrZ.js";
import { c as compareSemverStrings, f as DEFAULT_PACKAGE_CHANNEL, h as normalizeUpdateChannel, s as checkUpdateStatus, t as runGatewayUpdate, u as resolveNpmChannelTag } from "./update-runner-GHcvS82S.js";
...
import { i as probeGateway } from "./audit-BY9X5xYg.js";
...
import "./service-audit-WJenA6sB.js";
import "./node-service-CjtBRyjp.js";
import "./channels-status-issues-C9vMMPG0.js";
import "./status.update-0llkyCU7.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-DFZpbDDA.js";
import "./daemon-runtime-DE8lGPXZ.js";
...
import "./tui-u0qENWih.js";
import { t as buildChannelAccountSnapshot } from "./status-DkW6wMxZ.js";
import "./shared-ChNOqAzp.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-X4P8rNEF.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DZ6T2_MO.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-dM8CFqU7.js");
